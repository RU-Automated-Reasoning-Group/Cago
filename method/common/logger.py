...
class TerminalOutput:
    ...
    def _format_value(self, value):
        ...
        if value == 0:
            ...
            value = f'{value:.1e}'  # 12345.6789 --> 1.2e+04
            value = value.replace('.0e', 'e')  # 1.0e+y --> 1e+y
            value = value.replace('+0', '')  # 1.2e+04 --> 1.2e4
            value = value.replace('+', '')  #  1.2e+5 --> 1.2e5
            value = value.replace('-0', '-')  # 1.2e-03 --> 1.2e-3
        return value
